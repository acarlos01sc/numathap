...
void bindMathEnvironment(py::module_& m) {
    ...
    py::class_<numathap::MathEnvironment>(m, "MathEnvironment",
      ...
      NumericType: Active numeric type.
        ...
        .def_property_readonly("integration_algorithm",
      ...
      concrete type matches :attr:`integration_algorithm`.
        ...
        .def("capabilities", &numathap::config::MathEnvironment::capabilities,
             R"pbdoc(
Returns the configured processing capabilities in their execution order.
)pbdoc")
        .def("enable_capability", &numathap::MathEnvironment::enableCapability,
             py::arg("capability"),
             R"pbdoc(
      ...
      Args:
        ...
        .def("has_capability", &numathap::MathEnvironment::hasCapability,
             py::arg("capability"),
             R"pbdoc(
      ...
      Returns:
        ...
        .def_property_readonly("series_type",
                               &numathap::MathEnvironment::seriesType,
                               R"pbdoc(
      SeriesType: Currently selected series expansion type (see
      :class:`SeriesType`).
      )pbdoc")
        .def_property_readonly("series_config",
                               &numathap::MathEnvironment::seriesConfig,
                               R"pbdoc(
