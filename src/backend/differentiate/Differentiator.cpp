...
PreparedAst Differentiator::differentiate(const PreparedAst& ast,
  ...
  //
  auto preparedRoot = BackendSupport::cloneNode(*simplifiedAst.root());
...
MathNodePtr Differentiator::differentiateBinary(
  ...
  switch (node.op) {
    ...
    case BinaryOp::Multiply: {
      ...
      auto left = BackendSupport::cloneNode(*node.left);
      auto right = BackendSupport::cloneNode(*node.right);
    ...
    case BinaryOp::Divide: {
      ...
      auto left = BackendSupport::cloneNode(*node.left);
      auto right = BackendSupport::cloneNode(*node.right);
      auto denominator = BackendSupport::cloneNode(*node.right);
